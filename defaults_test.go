...
func TestDefaultValueIntFromString(t *testing.T) {
	tests := []struct {
		name        string
		expected    int
		defaultData int
	...
	for _, tt := range tests {
		tt := tt
		t.Run(tt.name, func(t *testing.T) {
			actual := DefaultValueIntFromString(tt.defaultData, tt.data)
			if actual != tt.expected {
...
func TestDefaultValueBoolFromString(t *testing.T) {
	tests := []struct {
		name        string
		expected    bool
		defaultData bool
	...
	for _, tt := range tests {
		tt := tt
		t.Run(tt.name, func(t *testing.T) {
			actual := DefaultValueBoolFromString(tt.defaultData, tt.data)
			if actual != tt.expected {
